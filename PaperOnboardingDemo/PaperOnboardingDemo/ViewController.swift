...
extension ViewController: PaperOnboardingDataSource {
    ...
    func onboardingItemAtIndex(index: Int) -> OnboardingItemInfo {
        ...
        return [
            (UIImage.Asset.Hotels.rawValue, "Hotels\nand other", "All hotels and\nhostels are sorted by hospitality rating", "", UIColor(red:0.40, green:0.56, blue:0.71, alpha:1.00), UIColor.whiteColor(), UIColor.whiteColor(), titleFont,descriptionFont),
