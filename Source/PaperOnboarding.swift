...
open class PaperOnboarding: UIView {
    ...
    var pageBorderColor:UIColor     = .white
    var pageSelectedBorderColor:UIColor = .white
    ...
    public init(itemCount: Int = 3, pageItemRadius:CGFloat, selectedRadius:CGFloat, pageBorderColor:UIColor = .white, pageSelectedBorderColor:UIColor = .white) {
        super.init(frame: CGRect.zero)
